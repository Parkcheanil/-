...
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/css/change.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/css/border.css">
      ...
      <div class="main_area_none">
        <div class="main_inner_none">
          <div class="inner_none">
            ...
            <div class="none_alert">교환 및 반품 신청 가능한 내역이 없습니다.</div>
          </div>
        </div>
      </div>
        ...
        <div class="goods_div">
          ...
          <div class="goods_info">
            ...
            <div class="info_etc">
              ...
              <button type="button" class="btn"><span>반품신청</span></button>
            </div>
          </div>
        </div>
      </div>
